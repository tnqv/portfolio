                            ...
                            <ul>
                                ...
                                <li>
                                  <ul className="no-top-padding">
                                    ...
                                    <li>
                                      <ul className="no-top-padding">
                                        <li>&lt;<span className="html-1">h1</span>&gt;
                                         Backend &lt;/<span className="html-1">h1</span>&gt;</li>
                                        ...
                                        <li>
                                          ...
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">Kubernetes</span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                        </ul>
                                        <li>&lt;/<span className="html-1">ul</span>&gt;</li>
                                    ...
                                    <li>
                                      <ul className="no-top-padding">
                                        <li>&lt;<span className="html-1">h1</span>&gt;
                                         Mobile & Website &lt;/<span className="html-1">h1</span>&gt;</li>
                                        <li>&lt;<span className="html-1">ul</span>&gt;</li>
                                        <ul className="no-top-padding">
                                        <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">Java(Android)</span>
                                            &lt;/<span className="html-1">li</span>&gt;</li>
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                          ...
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">HTML5 & CSS 3</span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                        </ul>
                                        <li>&lt;/<span className="html-1">ul</span>&gt;</li>
